...
def create_reference():
    ...
    reference = kt.run_kernel("dedispersion_reference", kernel_string, 1, args, {}, lang="C")
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        raise ValueError(
            f"Usage: python dedispersion_milo.py [language ('HIP' or 'CUDA')] [device name], given: {sys.argv[1:]}"
        )
